    ...
    <div className="about-us-opsi mt-5">
      ...
      <div className="iphone5-reng py-5">
        <div className="row align-items-center container"> 
          <div className="iphone5-left-side col-12 col-md-6 d-flex justify-content-center" data-aos="fade-right"> 
            <img className='iphone5-phone-png' src="./assets/images/aboutus/Iphone5.webp" alt="" />
          </div>
          <div className="iphone5-right-side col-12 col-md-6" data-aos="fade-left">
            <div className="d-flex flex-column container py-4 px-2"> 
              ...
              <p className='mb-0 paragraf-opacitys'>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Cum sociis natoque penatibus et magnis dis parturient montes.
        ...
        <div className="books container py-4" >
          <div className="row">
            ...
            <div className="Fa-Book-About"> <FaBook className='fa-book-color'/>
              ...
              <p className='text-center paragraf-opacitys'>Aenean lacinia bibendum nulla sed consectetur. Fusce dapibus, tellus ac cursus commodo, tortor mauris condi mentum nibh. Porta Aenean Adipiscing.</p>
      ...
      <div className='our-skills mt-5' >
          ...
          <div className="container">
            <div className="row">
              ...
              <h3 className='text-white py-4'>Story About US</h3>
            ...
            <div className="col-12 col-md-12 col-lg-6 skillboxlar py-5 " data-aos="fade-left">
              <li>
