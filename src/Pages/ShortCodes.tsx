  ...
  return (
    <div className='py-5'>
        <div className='about-us-picture'>
                <h3 className='text-center About-us-h3 text-white'>Shortcodes</h3>
            </div>
            <div className="container py-5">
              <div className="row">
                ...
                <div className='block-quote-type py-4'>
                  <h2>Block Quote</h2>
                </div>
                <div className='iki-dirnaq py-5'>
                   <RiDoubleQuotesL/>
                   <p className='py-3'>Cum sociis natoque penatus etaed pnis dis parturient montes, scettr aieo ridus mus. Etiam portaem mleyo.</p> 
                </div>
